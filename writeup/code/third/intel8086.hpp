...
namespace emu::cpu {
    ...
    public:
         ...
         * @param memory Reference to the memory of the emulated system.
         * @return Whether execution was successful or not.
         */
    ...
    private:
        ...
        /**
         * @param opcode The instruction opcode.
         * @param address The absolute address from which the given opcode was fetched.
